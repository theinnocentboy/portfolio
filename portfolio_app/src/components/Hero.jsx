      ...
      <motion.div variants={containerVariants} initial="hidden" animate="visible" className="max-w-4xl text-center relative z-10">
        <motion.div variants={itemVariants} className="flex justify-center mb-8">
          <div className="flex items-center gap-2 px-4 py-2 bg-tokyonight-bgStorm/80 border border-tokyonight-bgHighlight/50 rounded-full backdrop-blur-sm shadow-lg">
            <span className="relative flex h-3 w-3">
              ...
              <span className="relative inline-flex rounded-full h-3 w-3 bg-tokyonight-green"></span>
            </span>
            <span className="text-xs font-mono text-tokyonight-green uppercase tracking-wider">System.Status: Ready</span>
          </div>
        </motion.div>

        <motion.h1 variants={itemVariants} className="text-5xl md:text-7xl font-extrabold mb-6 tracking-tight text-tokyonight-fg drop-shadow-2xl">
          Sheikh Sahil
        </motion.h1>
        
        <motion.h2 variants={itemVariants} className="text-2xl md:text-3xl font-medium text-transparent bg-clip-text bg-gradient-to-r from-tokyonight-green to-tokyonight-cyan mb-8">
          Full-Stack Developer & Engineer
        </motion.h2>
        
        <motion.p variants={itemVariants} className="text-lg text-tokyonight-fgMuted mb-12 leading-relaxed max-w-2xl mx-auto font-light">
        ...
        <motion.div variants={itemVariants} className="flex flex-wrap justify-center gap-6">
          <motion.a 
            ...
            whileTap={{ scale: 0.95 }}
            className="group flex items-center gap-2 bg-tokyonight-green text-tokyonight-bg px-8 py-4 rounded-xl font-bold transition-all shadow-[0_0_20px_rgba(158,206,106,0.3)] hover:shadow-[0_0_40px_rgba(158,206,106,0.6)]"
          >
          ...
          <motion.a 
            ...
            whileHover={{ scale: 1.05, y: -4 }}
            whileTap={{ scale: 0.95 }}
            className="group flex items-center gap-2 bg-tokyonight-bgStorm border border-tokyonight-bgHighlight hover:border-tokyonight-comment px-8 py-4 rounded-xl font-semibold transition-all shadow-lg hover:shadow-[0_0_30px_rgba(192,202,245,0.1)] text-tokyonight-fgDim"
          >
          ...
          <motion.a 
            ...
            whileHover={{ scale: 1.05, y: -4 }}
            whileTap={{ scale: 0.95 }}
            className="group flex items-center gap-2 bg-tokyonight-blue/10 border border-tokyonight-blue/30 hover:border-tokyonight-blue px-8 py-4 rounded-xl font-semibold transition-all shadow-lg hover:shadow-[0_0_30px_rgba(122,162,247,0.3)] text-tokyonight-blue hover:text-tokyonight-cyan"
          >
